  ...
  return (
    <>
      <div
        ...
        className="group relative overflow-hidden rounded-xl border border-(--c1) bg-(--c2) shadow-md transition duration-300 hover:-translate-y-1 hover:shadow-xl"
      >
          ...
          <div className="relative shrink-0 flex">
            ...
            {isMenuOpen && (
              <div
                ...
                className="absolute bottom-13 right-0 z-20 w-30 overflow-hidden rounded-lg border border-gray-700 bg-(--c2) shadow-xl"
              >
                <button
